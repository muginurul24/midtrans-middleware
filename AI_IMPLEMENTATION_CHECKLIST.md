...
- [x] Hardening UI affordance dan developer docs juga sudah dinaikkan pada `2026-05-04`:
  ...
  - referensi docs sekarang hanya menampilkan kontrak yang memang dipakai client/store: `POST /v1/transactions/charge`, `GET /v1/transactions/{order_id}`, dan payload webhook ke callback URL toko, lengkap dengan method badge, header, body fields, response, dan contoh request untuk `curl`, `JavaScript`, `PHP`, `Go`, dan `Rust`
